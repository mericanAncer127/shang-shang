...
export default function ProjectItem({ title, image_src, github_url, url, role }: ProjectProps) {
  return (
    <a
      href={url}
      target="_blank"
      className="group flex w-full flex-col justify-center border-b px-4 py-10 sm:px-10 sm:py-16"
      rel="noreferrer"
    >
        ...
        >
          ...
          >
            <path
              stroke="#888"
              strokeWidth="2"
              d="M10.5 7.5h-4A2.5 2.5 0 0 0 4 10v6.5A2.5 2.5 0 0 0 6.5 19h7a2.5 2.5 0 0 0 2.5-2.5v-4"
            />
            <path stroke="#888" strokeWidth="2" d="M14.5 4h5v5" />
            <path stroke="#888" strokeWidth="2" d="M10 14.5 19.5 5" />
          </svg>
        </a>
      </div>
      <div className="flex flex-col items-center gap-4 w-full justify-between md:flex-row">
        <Image
          ...
          width={400}
          src={image_src}
          className="object-scale-down border-3 rounded-2xl"
        />
        <div className="flex flex-col justify-center items-center md:items-end gap-3 text-center md:text-right">
